 ...
 * @description TODO 报价单修改
 * @Iteration : 1.0
 * @Date : 2021/5/6  11:19 下午
...
public class OfferModifyTdo implements Serializable {
    private static final long serialVersionUID = 7619767008423363400L;


    //报价单号
    @NotBlank(message = "报采单号不能为空！")

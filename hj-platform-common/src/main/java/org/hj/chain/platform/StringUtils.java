...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     */
    public static String genUserId(Integer num) {
        return null;
    }
     ...
     * @Author: lijinku
     * @Iteration : 1.0
     * @Date: 2021/4/30 9:16 上午
     */
    public static String getFixLengStr(String prefix, int length, int preNo) {
        return prefix + String.format("%" + (length - prefix.length()) + "s", preNo + 1).replace(' ', '0');
    }
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> lists = splistList(list, 3);
